...
library Broken {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Broken", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000042726f6b656e00000000000000000000);
