...
library StartTile {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "StartTile", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000537461727454696c6500000000000000);
